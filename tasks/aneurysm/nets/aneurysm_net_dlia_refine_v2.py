...
class DAResUNet(nn.Module):
    ...
    def forward(self, x, draw=0):
        ...
        out5 = output
        # print('after up={}'.format(out5.shape))
        ...
        out9 = output
        # print('out9.shape={}'.format(out9.shape))
        output = self.refine(last_layer_3, output, self.up3)
        # print('output', output.shape)

        if draw:
            # intm_list = [x, output0, output1, output2, output3, out4, out5, last_layer_1, last_layer_2, last_layer_3, output]
